...
$(function() {
    ...
    getThumbnail('', function(returndata){
        var visitorsData = {};
        for(var i = 0; i < returndata.length; i++)
        {
            visitorsData[returndata[i]['country_code']] =  returndata[i]['quantity'];
        }
        ...
        $('#world-map').vectorMap({
            ...
            onRegionLabelShow: function(e, el, code) {
                if (typeof visitorsData[code] != "undefined")
                    el.html(el.html() + ': ' + visitorsData[code] + ' tablets');
            }
        });
    });
    ...
    var area = new Morris.Area({
        ...
        xkey: 'y',
        ykeys: ['item1', 'item2'],
        labels: ['Total Data', 'Post Processing'],
    ...
    var donut = new Morris.Donut({
        ...
        data: [
            {label: "South Africa", value: 12},
            {label: "Roanoke, AL ", value: 30},
            {label: "Wonchi - Ethiopia ", value: 20}
        ],
        hideHover: 'auto'
    });
    //Bar chart
